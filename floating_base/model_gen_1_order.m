...
% Export FK function
matlabFunction(fk_fcn,'File','automatically_generated/poly_order_1/fk_fcn_order_1','Vars',{p, q, s, d}); % creating the MatLab function

fid  = fopen('automatically_generated/poly_order_1/fk_fcn_order_1.m','r');
f=fread(fid,'*char')';
fclose(fid);
f = strrep(f,'fresnelc','fresnelc_approx');
f = strrep(f,'fresnels','fresnels_approx');
fid  = fopen('automatically_generated/poly_order_1/fk_fcn_order_1.m','w');
fprintf(fid,'%s',f);
fclose(fid);

% With orientation
matlabFunction(fka_fcn,'File','automatically_generated/poly_order_1/fka_fcn_order_1','Vars',{p, q, s, d}); % creating the MatLab function

fid  = fopen('automatically_generated/poly_order_1/fka_fcn_order_1.m','r');
f=fread(fid,'*char')';
fclose(fid);
f = strrep(f,'fresnelc','fresnelc_approx');
f = strrep(f,'fresnels','fresnels_approx');
fid  = fopen('automatically_generated/poly_order_1/fka_fcn_order_1.m','w');
fprintf(fid,'%s',f);
fclose(fid);
...
matlabFunction(G_fcn,'File','automatically_generated/poly_order_1/G_fcn_order_1','Vars',{p, q}); % creating the MatLab function

fid  = fopen('automatically_generated/poly_order_1/G_fcn_order_1.m','r');
f=fread(fid,'*char')';
fclose(fid);
f = strrep(f,'fresnelc','fresnelc_approx');
f = strrep(f,'fresnels','fresnels_approx');
fid  = fopen('automatically_generated/poly_order_1/G_fcn_order_1.m','w');
fprintf(fid,'%s',f);
fclose(fid);

matlabFunction(Gv_fcn,'File','automatically_generated/poly_order_1/Gv_fcn_order_1','Vars',{p, q, gamma}); % creating the MatLab function

fid  = fopen('automatically_generated/poly_order_1/Gv_fcn_order_1.m','r');
f=fread(fid,'*char')';
fclose(fid);
f = strrep(f,'fresnelc','fresnelc_approx');
f = strrep(f,'fresnels','fresnels_approx');
fid  = fopen('automatically_generated/poly_order_1/Gv_fcn_order_1.m','w');
fprintf(fid,'%s',f);
fclose(fid);
...
matlabFunction(B_fcn,'File','automatically_generated/poly_order_1/B_fcn_order_1','Vars',{p, q}); % creating the MatLab function

fid  = fopen('automatically_generated/poly_order_1/B_fcn_order_1.m','r');
f=fread(fid,'*char')';
fclose(fid);
f = strrep(f,'fresnelc','fresnelc_approx');
f = strrep(f,'fresnels','fresnels_approx');
fid  = fopen('automatically_generated/poly_order_1/B_fcn_order_1.m','w');
fprintf(fid,'%s',f);
fclose(fid);
...
matlabFunction(C_fcn,'File','automatically_generated/poly_order_1/C_fcn_order_1','Vars',{p, q, dq}); % creating the MatLab function

fid  = fopen('automatically_generated/poly_order_1/C_fcn_order_1.m','r');
f=fread(fid,'*char')';
fclose(fid);
f = strrep(f,'fresnelc','fresnelc_approx');
f = strrep(f,'fresnels','fresnels_approx');
fid  = fopen('automatically_generated/poly_order_1/C_fcn_order_1.m','w');
fprintf(fid,'%s',f);
fclose(fid);
