...
% Export FK function
matlabFunction(fk_fcn,'File','automatically_generated/poly_order_1/fk_fcn','Vars',{p, q, s, d}); % creating the MatLab function
...
% With orientation
matlabFunction(fka_fcn,'File','automatically_generated/poly_order_1/fka_fcn','Vars',{p, q, s, d}); % creating the MatLab function

fid  = fopen('automatically_generated/poly_order_1/fka_fcn.m','r');
f=fread(fid,'*char')';
fclose(fid);
f = strrep(f,'fresnelc','fresnelc_approx');
f = strrep(f,'fresnels','fresnels_approx');
fid  = fopen('automatically_generated/poly_order_1/fka_fcn.m','w');
fprintf(fid,'%s',f);
fclose(fid);
...
matlabFunction(G_fcn,'File','automatically_generated/poly_order_1/G_fcn','Vars',{p, q}); % creating the MatLab function
...
matlabFunction(Gv_fcn,'File','automatically_generated/poly_order_1/Gv_fcn','Vars',{p, q, gamma}); % creating the MatLab function
...
matlabFunction(B_fcn,'File','automatically_generated/poly_order_1/B_fcn','Vars',{p, q}); % creating the MatLab function
...
matlabFunction(C_fcn,'File','automatically_generated/poly_order_1/C_fcn','Vars',{p, q, dq}); % creating the MatLab function
