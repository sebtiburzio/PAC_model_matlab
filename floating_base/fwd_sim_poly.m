...
addpath('automatically_generated/poly_order_0/')
addpath('automatically_generated/poly_order_1/')
addpath('automatically_generated/poly_order_2/')
addpath('automatically_generated/poly_order_3/')
addpath('automatically_generated/poly_order_4/')
addpath('automatically_generated/poly_order_5/')

% global k_obj K p_vals Theta_bar
% k_obj is object stiffness
% Theta_bar is the object offset stiffness
