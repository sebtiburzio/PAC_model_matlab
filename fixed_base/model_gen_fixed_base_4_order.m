...
syms theta_0 theta_1  theta_2 theta_3 theta_4 dtheta_0 dtheta_1 dtheta_2 dtheta_3 dtheta_4 ddtheta_0 ddtheta_1 ddtheta_2 ddtheta_3 ddtheta_4
theta = [theta_0;theta_1;theta_2;theta_3;theta_4];
dtheta = [dtheta_0;dtheta_1;dtheta_2;dtheta_3;dtheta_4];
ddtheta = [ddtheta_0;ddtheta_1;ddtheta_2;ddtheta_3;ddtheta_4];
...
% Export FK function
matlabFunction(fk_fcn,'File','automatically_generated/poly_order_4/fk_fcn','Vars',{p, theta, s, d}); % creating the MatLab function
...
% Potential force
G_fcn = jacobian(9.81*(subs(U,gamma,0)),[theta_0; theta_1; theta_2; theta_3; theta_4])'; % Gravity field Z direction
Gv_fcn = jacobian(9.81*(U),[theta_0; theta_1; theta_2; theta_3; theta_4])'; % Variable gravity field

toc

matlabFunction(G_fcn,'File','automatically_generated/poly_order_4/G_fcn','Vars',{p, theta}); % creating the MatLab function
...
matlabFunction(Gv_fcn,'File','automatically_generated/poly_order_4/Gv_fcn','Vars',{p, theta, gamma}); % creating the MatLab function
...
J = jacobian(subs(fk_fcn,s, 1),[theta_0; theta_1; theta_2; theta_3; theta_4]);
B_fcn = m_E*int(J'*J, d, -1/2, 1/2);
for i = 0:num_masses-1
    J = jacobian(subs(fk_fcn, s, i/num_masses + 1/(num_masses*2)),[theta_0; theta_1; theta_2; theta_3; theta_4]);
    B_fcn = B_fcn + (m_L/num_masses)*int(J'*J, d, -1/2, 1/2);
end

toc

matlabFunction(B_fcn,'File','automatically_generated/poly_order_4/B_fcn','Vars',{p, theta}); % creating the MatLab function
...
matlabFunction(C_fcn,'File','automatically_generated/poly_order_4/C_fcn','Vars',{p,theta,dtheta}); % creating the MatLab function
