...
Gv_fcn = [et1+et2;et3+et4+et5+et6;m_E.*t4.*(9.81e+2./1.0e+2)+m_L.*t4.*(9.81e+2./1.0e+2);m_E.*t3.*(9.81e+2./1.0e+2)+m_L.*t3.*(9.81e+2./1.0e+2);et7+et8];
