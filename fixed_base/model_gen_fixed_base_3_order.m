...
syms theta_0 theta_1 theta_2 theta_3 dtheta_0 dtheta_1 dtheta_2 dtheta_3 ddtheta_0 ddtheta_1 ddtheta_2 ddtheta_3
theta = [theta_0;theta_1;theta_2;theta_3];
dtheta = [dtheta_0;dtheta_1;dtheta_2;dtheta_3];
ddtheta = [ddtheta_0;ddtheta_1;ddtheta_2;ddtheta_3];
...
% Potential force
G_fcn = jacobian(9.81*(subs(U,gamma,0)),[theta_0; theta_1; theta_2; theta_3])'; % Gravity field Z direction
Gv_fcn = jacobian(9.81*(U),[theta_0; theta_1; theta_2; theta_3])'; % Variable gravity field
